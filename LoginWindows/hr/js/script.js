...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const rememberCheckbox = document.getElementById('hr-remember');
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (response.success) {
                showSuccess('HR Login successful! Redirecting...');
                setTimeout(() => {
    ...
    function simulateLogin(credentials) {
        return new Promise((resolve) => {
            ...
            setTimeout(() => {
                // Simple validation
                if (credentials.email === 'hr@example.com' && credentials.password === 'hrpassword123') {
